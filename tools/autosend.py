...
with open('config/autosend.json') as f:
  ...
  for c in data['Config']:
        print('Loading...')
channelid = c['channelid'] #modify this in config/autosend.json
token = c['token'] #modify this in config/autosend.json
message = c['message'] #modify this in config/autosend.json
web = c['web'] #modify this in config/autosend.json
header_data = { 
